...
1. **Клонируйте репозиторий:**
    ...
    cd my_gpt
    ```
2. запустите файл `activate_venv.bat`, он установит окружение, установить зависимости и запустит приложение
    ```bash
    activate_venv.bat
    ```
## Использование
в дальнейшем можно будет запускать чат с помощью `run_gpt.bat`
